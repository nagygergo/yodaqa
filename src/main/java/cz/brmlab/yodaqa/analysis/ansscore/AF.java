...
public class AF {
	...
	* "questionClassABBR". */
	...
	/** Answer Feature: Cosine distance in word2vec corpus is between the answer and the closest LAT
	  */
	public static final String Word2Vec_Closeness = "Word2Vec_Closeness";
};
