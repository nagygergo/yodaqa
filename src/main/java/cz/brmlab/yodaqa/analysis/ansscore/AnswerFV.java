...
public class AnswerFV {
	...
	public static String labels[] = {
		...
		"originPsg", "originPsgFirst",
			"originPsgByClue","originPsgByClueToken", "originPsgByCluePhrase", "originPsgByClueSV",
		...
		"originDocTitle",
		"originBingSnippet",
		"originDBpOntology", "originDBpOClue", "originDBpONoClue",
		...
		"originDBpProperty", "originDBpPClue", "originDBpPNoClue",
		...
		"originMultiple",
		"psgDistClueToken", "psgDistClue", "psgDistCluePhrase", "psgDistClueSV",
